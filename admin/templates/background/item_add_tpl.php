...
<form name="supplier" id="validate" class="form" action="index.php?com=background&act=save<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" method="post" enctype="multipart/form-data">
	<div class="widget">
        ...
        <div id="content_lang_<?=$key?>" class="tab_content">	
            ...
            <div class="formRow">
                ...
                <div class="formRight">
                    ...
                    <?php if($_REQUEST['type']=='banner') { ?><span class="size_img">Chiều rộng <b>1366px</b> Chiều cao: <b>135px</b></span><?php } ?>
                    <?php if($_REQUEST['type']=='logo') { ?><span class="size_img">Chiều rộng <b>250px</b> Chiều cao: <b>105px</b></span><?php } ?>
                    <?php if($_REQUEST['type']=='bannerqc') { ?><span class="size_img">Chiều rộng <b>1366px</b> Chiều cao: <b>350px</b></span><?php } ?>
        ...
        <?php if($_REQUEST['type']=='pupop' || $_REQUEST['type']=='bannerqc') { ?>
        <div class="formRow">
