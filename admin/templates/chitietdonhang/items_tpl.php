...
<h3>Quản lý chi tiết đơn hàng&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tên: <input type="text" id="key" name="key" placeholder="Nhập từ khóa..." value="<?=$_REQUEST['key']?>" /><input type="button" value="Tìm" onclick="timkiem();" /> </h3>
