...
<form name="supplier" id="validate" class="form" action="index.php?com=hinhanh&act=save_photo&id_hinhanh=<?=$_REQUEST['id_hinhanh']?>&type=<?=$_REQUEST['type']?><?php if($_REQUEST['p']!='') echo'&p='.$_REQUEST['p'];?>" method="post" enctype="multipart/form-data">
