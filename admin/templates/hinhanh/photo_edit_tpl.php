<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
        	            <li><a href="index.php?com=hinhanh&act=man_photo<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>"><span>Hình ảnh</span></a></li>
...
<form name="supplier" id="validate" class="form" action="index.php?com=hinhanh&act=save_photo&id=<?=$_REQUEST['id'];?><?php if($_REQUEST['id_hinhanh']!='') echo'&id_hinhanh='. $_REQUEST['id_hinhanh'];?><?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?><?php if($_REQUEST['p']!='') echo'&p='.$_REQUEST['p'];?>" method="post" enctype="multipart/form-data">
	<div class="widget">
       ...
       <div id="info" class="tab_content"> 
		...
		<div class="formRow">
			...
			<div class="formRight">
               ...
               <div class="note">  <?php if($_REQUEST['type']=='sanpham')echo 'Width:350px &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Height:200px '; ?>
                <?php if($_REQUEST['type']=='hinhanh2')echo 'Width:1366px &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Height:650px '; ?>   
	...
	<div class="formRow">
			<div class="formRight">
                ...
                <input type="hidden" name="id_hinhanh" id="id_hinhanh" value="<?=$_REQUEST['id_hinhanh']?>" />
