...
<form name="supplier" id="validate" class="form" action="index.php?com=news&act=save&p=<?=$_REQUEST['p']?><?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" method="post" enctype="multipart/form-data">
    ...
    <?php }?>
       ...
       <?php if($_GET['type']!='hotro' && $_GET['type']!='gioithieun' && $_GET['type']!='baogia'){?>
        <div class="formRow">
...
<!-- dowloadfile -->
      ...
      <div class="formRight">
              <input type="file" id="file1" name="file1" accept="image/*" onchange="loadFile(event)" />
        <img src="./images/question-button.png" alt="Upload file" class="icon_question tipS" original-title="Tải file doc|xls|ppt|pdf|rar|win|zip|docx|pptx|xlsx|DOC|XLS|PPT|PDF|RAR|WIN|ZIP|DOCX|PPTX|XLSX">
    ...
    <div class="formRow">
      ...
      <div class="formRight">
      <div class="mt10"><?=$item['download']?></div>
      </div>
      <div class="clear"></div>
    </div>
...
<?php }?>
    ...
    <?php }?>
 	...
 	<div class="formRow">
        ...
        <?php if($_GET['type']=='tintuc' || $_GET['type']=='daychuyen') { ?>
        <div class="formRow">
        ...
        <div class="formRow">
          <label>Mới nhất: <img src="./images/question-button.png" alt="Chọn loại" class="icon_que tipS" original-title="Bỏ chọn để không hiển thị danh mục này !"> </label>
       ...
       <div id="content_lang_<?=$key?>" class="tab_content">        
        ...
        <?php if($_GET['type']!='hotro' && $_GET['type']!='gioithieun'){?>
        <div class="formRow">
