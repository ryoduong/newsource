<?php  if(!defined('_source')) die("Error");
	...
	else if($id!='')
	{
		...
		//Chi tiết sản phẩm
		$d->reset();
		$sql_detail = "select id,ten$lang as ten,mota$lang as mota,noidung$lang as noidung,masp,gia,giakm,luotxem,thumb,photo,size,mausac,id_danhmuc,id_list,id_cat,title,keywords,description FROM #_product where hienthi=1 and id='$id' limit 0,1";
		$d->query($sql_detail);
