<?php if($deviceType=='phone') { ?>
	<style>div.phone_mobi{background: rgba(1, 116, 35, 0.7803921568627451);width:100%;position:fixed;left:0;bottom:0;height:50px;line-height:50px;color:#fff; z-index:50;}
