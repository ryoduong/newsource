<?php
	...
	$d->reset();
	$sql_slider = "select ten,link,photo from #_slider where hienthi=1 and type='slider' order by stt,id desc";
	$d->query($sql_slider);
...
<div id="slider1_container" style="position: relative; width: 1366px;
        ...
        <div u="loading" style="position: absolute; top: 0px; left: 0px;">
            <div style="filter: alpha(opacity=70); opacity:0.7; position: absolute; display: block;
                background-color: #000; top: 0px; left: 0px;width: 1366px;height:100%;">
            </div>
        ...
        <!-- Slides Container -->
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1366px; height: 100%;
            overflow: hidden;">
            <?php  for($i=0,$count_slider=count($slider);$i<$count_slider;$i++){ ?>
                
                <div>
                    <a u=image href="#"><img src="<?php if($slider[$i]['photo']!='')echo _upload_hinhanh_l.$slider[$i]['photo'];else echo 'images/noimage.png' ?>" /></a>
