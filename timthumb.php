...
define ('CACHE_CLEAR', 200);					// maximum number of files to delete on each cache clear
...
define ('DIRECTORY_CACHE', './upload/cache');		// cache directory
...
define ('CURL_TIMEOUT', 100);				// timeout duration. Tweak as you require (lower = better)
